...
<br>
从1990年IEEE 1149.1标准发布到今天的cJTAG和SWD竞争，JTAG用5根线统治了芯片测试和调试领域三十余年。
<br>
然而，引脚数量的限制和新兴调试需求正推动替代方案的发展。
<br>
...
### <strong>IEEE 1687：可重构的边界扫描</strong>
...
3. 假设你正在设计一款48引脚的Cortex-M4 MCU，需要同时支持SWD调试和边界扫描测试。如何在引脚复用和成本之间做权衡？请给出具体的引脚分配方案。
...
- <span class="badge-e">[Expert]</span> 深入研究SWD协议细节、DAP架构和IJTAG动态扫描路径配置。
- <span class="purple">扩展阅读：IEEE 1149.1-2013标准、ARM SW-DP规范、OpenOCD源码中的SWD驱动实现。
</span><br>