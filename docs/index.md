...
??? details "第二部 核心机制深度解析  <span class="tag tag-done">完成</span> <span class="meta">最后更新： 2026年8月6日</span>"
    ...
    | 第10章 中断与时间 | 硬件中断如何变成软件事件？ | 掌握GIC、顶半部/底半部、hrtimer、tickless；AI二轮复检完成（10.5/10.6/10.7 逐节 v6.6 事实核对：10.5.2 timekeeper 路径与注册函数名、10.5.3 改名去「级联」、10.5.4 rb_root_cached 与 nanosleep hard 类、10.5.6 alarm API 签名、10.6.2 tick mode 枚举、10.6.3 PM QoS 约束接口重写、10.7.2 样本数对齐；全章总结统一「散文收口+速查表」） | <span class="tag tag-done">ongoing</span> | 人工复检中 | 2026年9月7日 |
