...
| 子项 | AI完成情况 | 是否人工复检 | 最后修改日期 |
|------|-----------|------------|------------|
| 多线程编程 (pthread, 同步原语, 实时线程) [B→I] | 建设中 | 否 | 2026-05-04 |
| 进程间通信 (管道, MQ, D-Bus, 共享内存) [I] | 建设中 | 否 | 2026-05-04 |
| 网络编程 (Socket, lwIP, MQTT/CoAP) [I] | 建设中 | 否 | 2026-05-04 |
| 开发工具链 (GDB, 交叉编译, CMake) [B] | 建设中 | 否 | 2026-05-04 |
| 轻量级容器化技术 (Docker, Buildroot, systemd-nspawn) [I→E] | 建设中 | 否 | 2026-05-04 |
| 低功耗与可靠性设计 (看门狗, DVFS, Runtime PM) [I] | 建设中 | 否 | 2026-05-04 |
| 性能分析与优化 (strace, perf, Valgrind, 火焰图) [I→E] | 建设中 | 否 | 2026-05-04 |
| 系统服务化 (systemd, 守护进程, 故障恢复) [I] | 建设中 | 否 | 2026-05-04 |
