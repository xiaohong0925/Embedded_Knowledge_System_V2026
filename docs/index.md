...
??? details "第二部 核心机制深度解析  <span class="tag tag-done">完成</span> <span class="meta">最后更新： 2026年8月6日</span>"
    ...
    | 第10章 中断与时间 | 硬件中断如何变成软件事件？ | 掌握GIC、顶半部/底半部、hrtimer、tickless；AI复检（30节全量：虚构内核代码换v6.6真实实现、10.5.3时间轮改4.8后扁平数组、跨节重复收敛、PREEMPT_RT主线时间线更正） | <span class="tag tag-done">ongoing</span> | 人工复检中 | 2026年8月27日 |
