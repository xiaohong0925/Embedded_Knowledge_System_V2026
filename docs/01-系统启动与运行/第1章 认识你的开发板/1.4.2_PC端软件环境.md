...
本节介绍PC端与开发板通信必备的串口终端工具。<BR>学完本节，你将能够在Windows、Linux或Mac上安装串口驱动、选择合适的终端工具，并正确配置115200 8N1参数与开发板建立连接。

---

## <span class="blue"> 串口终端工具选择 [B] 
...
## <span class="blue"> 串口参数配置——波特率115200与8N1 [B] 
...
串口连接成功后，你应该能在终端窗口看到开发板的启动信息（或一个命令提示符）。<BR>下一节（1.4.3）我们将进行第一次串口连接实战——给开发板上电、观察启动日志、进入交互式命令行。
