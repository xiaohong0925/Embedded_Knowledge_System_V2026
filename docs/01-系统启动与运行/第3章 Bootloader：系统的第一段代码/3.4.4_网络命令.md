...
## 本节导读
本节讲解U-Boot中的网络相关命令，包括IP地址配置、TFTP下载内核镜像、NFS挂载根文件系统以及DHCP自动获取IP。<br>学完后，你将能够通过网络方式向开发板传输文件，这是嵌入式开发中最常用的调试手段。

## <span class="blue"> 网络环境配置 [B] 
