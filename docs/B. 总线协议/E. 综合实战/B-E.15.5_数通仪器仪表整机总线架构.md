...
![aa](images/15.5-网络测试仪整机.png)

![aa](images/15.5-核心交换机前面板.png)
...
```
 ...
 └────────────────────────────────────────────────────────┘
```
![aa](images/2U机架式机箱技术截面图生成需求.png)
...
```
![aa](images/15.5-背板连接器.png)

```
 对外：前面板光口，接被测设备（DUT）
```
![aa](images/15.5-光笼子.png)
...
![aa](images/serdes_channel_budget.png)
