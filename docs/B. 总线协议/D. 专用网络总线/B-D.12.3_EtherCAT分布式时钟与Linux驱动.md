# B-D.12.3 EtherCAT分布式时钟与Linux驱动

> 所属章节：第五部 B. 总线协议 > B-D.12 EtherCAT工业以太网
>
...
下一节 **B-D.12.4 PROFINET与OPC UA**，我们将把目光转向西门子主导的工业以太网生态。PROFINET IRT如何实现与EtherCAT DC相媲硬的同步精度？OPC UA如何成为工业4.0时代统一的"数据语言"？当EtherCAT遇上IT/OT融合趋势，这些协议如何互补共存？敬请期待。
