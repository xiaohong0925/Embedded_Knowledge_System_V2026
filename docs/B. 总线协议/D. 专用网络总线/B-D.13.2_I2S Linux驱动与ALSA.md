...
> 所属章节：第五部 B. 总线协议 > B-D.13 I2S音频总线
>
...
下一节 **B-D.13.3 SPDIF与音频接口选型**，我们将跳出I2S，看看另一种常见的数字音频接口——SPDIF（Sony/Philips Digital Interface Format）。SPDIF只需一根线（同轴或光纤）就能传输数字音频，不需要BCLK/LRCK分离时钟，在电视、音响、功放之间的互联场景非常流行。我们会对比I2S和SPDIF的适用场景，帮你做音频接口选型决策。
