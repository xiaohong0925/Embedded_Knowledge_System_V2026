...
> 所属章节：第五部 B. 总线协议 > B-D.10 PCI Express总线
>
...
下一节 **B-D.10.2 PCIe枚举与配置空间** 将深入PCIe的软件层面——系统如何枚举总线、分配BDF地址、解析256字节/4KB配置空间、配置BAR内存映射。这些知识是编写PCIe设备驱动的基础，也是调试"设备认不到"、"BAR映射失败"等问题的关键。
