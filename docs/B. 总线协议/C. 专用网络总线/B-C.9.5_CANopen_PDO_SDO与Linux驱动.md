# B-C.9.5 CANopen PDO、SDO与Linux驱动
...
在下一节**`B-C.10.2 EtherCAT协议深度解析`**中，你将了解到：
...
- CiA-402状态机详解：见**B-C.9.6 CiA-402运动控制状态机**
- CANopen Bootloader固件升级：见**B-C.9.7 CANopen网络管理与诊断**
