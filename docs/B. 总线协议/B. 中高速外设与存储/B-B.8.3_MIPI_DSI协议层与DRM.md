...
下一节 **B-B.8.4 LVDS eDP HDMI DisplayPort**，我们将跳出MIPI生态，看看嵌入式系统中其他主流显示接口的技术特点和选型考量——LVDS的工业长距离传输优势、eDP的自刷新节能机制、HDMI的消费电子兼容性、DisplayPort的高带宽与嵌入式eDP变体。你会了解到，为什么工业平板偏爱LVDS、高端笔记本转向eDP、而树莓派同时提供DSI和HDMI输出。
